...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const response = await axios.get('https://keeping-faith-api.onrender.com/api/v1/profile', {
        headers: {
  ...
  const updateProfile = async (formData: FormData) => {
    try {
      ...
      await axios.put('https://keeping-faith-api.onrender.com/api/v1/profile', formData, {
        headers: {
          Authorization: `Bearer ${currentToken}`,
